...
?>
<form class="form-horizontal" method="POST" action="processa/proc_edit_empresa_sobre.php">
  ...
  <div class="row">
		<div class="col-md-12">
            <div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" name="empresa_titulo_sobre_ingles" placeholder="titulo em ingles" value="<?php echo $linhas['empresa_titulo_sobre_ingles']; ?>">
				</div>
			</div>
			<div class="form-group">
				<label for="inputEmail3" class="col-sm-2 control-label">Texto em Ingles</label>
				<div class="col-sm-10">
                    <textarea class="form-control" rows="5" name="empresa_texto_sobre_ingles" placeholder="Texto em Ingles"><?php echo $linhas['empresa_texto_sobre_ingles']; ?></textarea>
				</div>
			</div>	
            <div class="form-group">
				<label for="inputEmail3" class="col-sm-2 control-label">Titulo Japones</label>
				<div class="col-sm-10">
					<input type="text" class="form-control" name="empresa_titulo_sobre_japones" placeholder="titulo em Japones" value="<?php echo $linhas['empresa_titulo_sobre_japones']; ?>">
				</div>
			</div>
            <div class="form-group">
				<label for="inputEmail3" class="col-sm-2 control-label">Texto em Japones</label> 
				<div class="col-sm-10">
                    <textarea class="form-control" rows="5" name="empresa_texto_sobre_japones" placeholder="Texto em Japones"><?php echo $linhas['empresa_texto_sobre_japones']; ?></textarea>
				</div>
			</div>	
