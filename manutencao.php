...
<body>
	<!-- login-page -->
	<div class="login-page" style="padding:10%">
		<div class="container"> 
        <h2 class="form-signin-heading text-center"><img src='adm/imgSite/logo.png'></h2><br><br>
    		<div class="login-body">
                <span style="text-align: center; display:block;"><?php echo nl2br($linhas["empresa_texto_manutencao"]);?></span>
			</div>  
		</div>
	</div>
	<!-- //login-page --> 
