...
<body>
	...
	<div class="login-page">
		<div class="container"> 
            ...
            ?>
				 <h3 class="w3ls-title w3ls-title1"><?php echo $line["empresa_titulo_privacidade_".$msg_idioma]; ?></h3>  
				 <span style="text-align: justify; display:block;"><?php echo nl2br($line["empresa_texto_privacidade_".$msg_idioma]);?></span>
			</div>  
		</div>
	</div>
	<!-- //sign up-page --> 
